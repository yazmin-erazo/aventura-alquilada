...
const ProductsService = {
  getAll: () =>
    API.get(PRODUCTS_ENDPOINTS.ALL_PRODUCTS).then((res) => res.data),

  getById: (id) =>
    API.get(PRODUCTS_ENDPOINTS.PRODUCT_DETAILS + id).then((res) => res.data),

  create: (payload) =>
    API.post(PRODUCTS_ENDPOINTS.CREATE_PRODUCT, payload).then(
      (res) => res.data
    ),
